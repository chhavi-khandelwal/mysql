...
UPDATE users u INNER JOIN accounts a ON u.account_no = a.account_no SET a.balance = a.balance - 500 WHERE name = "userA";
-- Query OK, 1 row affected (0.00 sec)
-- Rows matched: 1  Changed: 1  Warnings: 0
...
UPDATE users u INNER JOIN accounts a ON u.account_no = a.account_no SET a.balance = a.balance - 200 WHERE name = "userA";
-- Query OK, 1 row affected (0.00 sec)
-- Rows matched: 1  Changed: 1  Warnings: 0

UPDATE users u INNER JOIN accounts a ON u.account_no = a.account_no SET a.balance = a.balance + 200 WHERE name = "userB";
-- Query OK, 1 row affected (0.00 sec)
-- Rows matched: 1  Changed: 1  Warnings: 0
